...
gwas_list=pd.read_csv("/home/yt4/projects/SS_GS_233ids/list_of_GS_biggest_GWASids.txt",header=None)
...
window_sig=5e5
window_gene=0
path2save="gs://genetics-portal-dev-sumstats/tmp/yt4-filtered-GS-233/"
